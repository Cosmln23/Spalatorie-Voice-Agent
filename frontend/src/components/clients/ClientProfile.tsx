          ...
          {activeTab === 'overview' && (
            <div className="space-y-6">
                ...
                <div className="bg-background rounded-2xl p-4 border border-border">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className={cn('text-sm', client.gdprConsent ? 'text-green-400' : 'text-red-400')}>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                <div className="bg-background rounded-2xl p-4 border border-border text-center">
                  <AlertTriangle className={cn("w-8 h-8 mx-auto mb-2", client.noShows && client.noShows > 0 ? 'text-red-400' : 'text-green-400')} />
            ...
            <div className="space-y-6">
              ...
              <div className="bg-background rounded-2xl p-4 border border-border">
                ...
                <div className="space-y-2">
                  ...
                  <button className="w-full text-left p-3 text-red-400 hover:bg-red-500/10 rounded-2xl transition-colors">
